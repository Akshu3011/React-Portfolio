      ...
      <div className="container">
        ...
        <Box sx={{ flexGrow: 1, bgcolor: "background.paper", display: "flex" }}>
          ...
          <TabPanel value={value} index={0}>
            ...
            <p>
              Curriculum included HTML5, CSS3, JavaScript, Bootstap, Express.js,
              react.js, JQuery, MongoDB,Node.js,MySQL, Command Line, Git and
              more.
            </p>
            <p>
          ...
          <TabPanel value={value} index={2}>
            ...
            <ul>
              <li>
                Performed Functionality, Integration, validation, and UI Testing
              </li>
              <li>Prepared defect reports and defect tracking</li>
              <li>
                Worked with the automation team to determine the feasibility of
                manual test cases that can be automated
              </li>
              <li>
